...
void main()
{
   ...
   vec3 first = vec3(0.937,0.859,0.773);
   vec3 second = vec3(0.584,0.784,0.541);
   vec3 third = vec3(0.541,0.635,0.443);
   vec3 fourth = vec3(0.267,0.51,0.561);
   vec3 fifth = vec3(0.416,0.294,0.267);
   vec3 sixth = vec3(0.176,0.196,0.125);
   vec3 black  = vec3(0.169,0.,0.106);
