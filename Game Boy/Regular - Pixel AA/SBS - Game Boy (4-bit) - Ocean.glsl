...
// Recommended Console: Game Boy (Double Cherry GB)
...
// This shader has only been tested with Gambatte and DoubleCherryGB.
// Use the mixed-frames version if your game requires ghosting.
...
{
   // palette
   vec3 white  = vec3(0.984,0.945,0.816); // White
   vec3 first = vec3(0.361,0.757,0.557);
   vec3 second = vec3(0.333,0.325,0.569);
   vec3 black  = vec3(0.004,0.043,0.224); // Black
