...
{
   // palette
   vec3 white  = vec3(0.976,0.961,0.663);
   vec3 first = vec3(0.698,0.925,0.757);
   vec3 second = vec3(0.565,0.796,0.208);
   vec3 third = vec3(0.,0.722,0.502);
   vec3 fourth = vec3(0.,0.525,0.694);
   vec3 fifth = vec3(0.188,0.329,0.576);
   vec3 sixth = vec3(0.082,0.208,0.231);
   vec3 black  = vec3(0.,0.102,0.031);
