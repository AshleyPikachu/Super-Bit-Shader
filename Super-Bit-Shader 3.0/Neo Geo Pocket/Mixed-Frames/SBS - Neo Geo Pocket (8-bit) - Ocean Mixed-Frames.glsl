...
{
   // palette
   vec3 white  = vec3(1.,0.945,0.663);
   vec3 first = vec3(0.655,0.91,1.);
   vec3 second = vec3(0.,0.847,0.518);
   vec3 third = vec3(0.,0.71,0.82);
   vec3 fourth = vec3(0.404,0.416,0.824);
   vec3 fifth = vec3(0.,0.373,0.435);
   vec3 sixth = vec3(0.102,0.196,0.325);
   vec3 black  = vec3(0.,0.043,0.286);
