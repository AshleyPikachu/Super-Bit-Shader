...
{
   // palette
   vec3 white  = vec3(1.,0.965,0.906); // White
   vec3 first = vec3(0.91,0.875,0.812);
   vec3 second = vec3(0.494,0.647,0.459);
   vec3 third = vec3(0.404,0.467,0.384);
   vec3 black  = vec3(0.122,0.208,0.106); // Black
