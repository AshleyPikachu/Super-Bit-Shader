...
{
// Core Palette
   vec3 white  = vec3(1.,0.957,0.675);
   vec3 first = vec3(0.98,0.91,0.627);
   vec3 second = vec3(0.655,0.91,1.);
   vec3 third = vec3(0.592,0.847,1.);
   vec3 fourth = vec3(0.,0.847,0.518);
   vec3 fifth = vec3(0.,0.784,0.459);
   vec3 sixth = vec3(0.,0.71,0.82);
   vec3 seventh = vec3(0.,0.639,0.757);
   vec3 eighth = vec3(0.404,0.416,0.824);
   vec3 ninth = vec3(0.329,0.357,0.78);
   vec3 tenth = vec3(0.239,0.333,0.498);
   vec3 eleventh = vec3(0.196,0.271,0.392);
   vec3 twelfth = vec3(0.,0.227,0.278);
   vec3 thirteenth = vec3(0.,0.153,0.204);
   vec3 fourteenth = vec3(0.,0.043,0.286);
   vec3 black  = vec3(0.,0.,0.216);
