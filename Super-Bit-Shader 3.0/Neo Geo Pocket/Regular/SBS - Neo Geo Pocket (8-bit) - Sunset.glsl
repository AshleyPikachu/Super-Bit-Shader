...
{
   // palette
   vec3 white  = vec3(0.973,0.949,0.816);
   vec3 first = vec3(0.941,0.855,0.8);
   vec3 second = vec3(0.835,0.718,0.416);
   vec3 third = vec3(0.863,0.506,0.447);
   vec3 fourth = vec3(0.592,0.384,0.576);
   vec3 fifth = vec3(0.475,0.267,0.349);
   vec3 sixth = vec3(0.118,0.188,0.337);
   vec3 black  = vec3(0.071,0.027,0.22);
