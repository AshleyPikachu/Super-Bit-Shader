...
{
   // palette
   vec3 white  = vec3(0.949,0.863,0.843); // White
   vec3 first = vec3(1.,0.847,0.678);
   vec3 second = vec3(0.898,0.51,0.667);
   vec3 third = vec3(0.698,0.42,0.545);
   vec3 fourth = vec3(0.498,0.369,0.557);
   vec3 fifth = vec3(0.271,0.204,0.31);
   vec3 sixth = vec3(0.243,0.267,0.357);
   vec3 black  = vec3(0.098,0.125,0.208); // Black
