...
{
   // palette
   vec3 white  = vec3(1.,0.969,0.906); // White
   vec3 first = vec3(0.902,0.875,0.812);
   vec3 second = vec3(0.796,0.537,0.525);
   vec3 third = vec3(0.537,0.42,0.412);
   vec3 black  = vec3(0.318,0.075,0.094); // Black
