...
{
   // palette
   vec3 white  = vec3(0.949,0.843,0.855); // White
   vec3 first = vec3(0.937,0.694,0.635);
   vec3 second = vec3(0.886,0.518,0.506);
   vec3 third = vec3(0.678,0.424,0.408);
   vec3 fourth = vec3(0.467,0.451,0.412);
   vec3 fifth = vec3(0.267,0.259,0.231);
   vec3 sixth = vec3(0.243,0.275,0.357);
   vec3 black  = vec3(0.098,0.129,0.208); // Black
