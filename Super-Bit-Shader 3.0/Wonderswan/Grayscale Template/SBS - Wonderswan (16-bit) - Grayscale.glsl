...
// Core Palette
   ...
   vec3 first = vec3(0.937,0.937,0.937);
   vec3 second = vec3(0.871,0.875,0.871);
   vec3 third = vec3(0.808,0.812,0.808);
   vec3 fourth = vec3(0.741,0.729,0.741);
   vec3 fifth = vec3(0.678,0.667,0.678);
   vec3 sixth = vec3(0.612,0.604,0.612);
   vec3 seventh = vec3(0.549,0.541,0.549);
   vec3 eighth = vec3(0.451,0.459,0.451);
   vec3 ninth = vec3(0.388,0.396,0.388);
   vec3 tenth = vec3(0.322,0.333,0.322);
   vec3 eleventh = vec3(0.259,0.271,0.259);
   vec3 twelfth = vec3(0.192,0.188,0.192);
   vec3 thirteenth = vec3(0.129,0.125,0.129);
   vec3 fourteenth = vec3(0.063,0.063,0.063);
