...
{
   // palette
   vec3 white  = vec3(0.949,0.875,0.843); // White
   vec3 first = vec3(1.,0.827,0.678);
   vec3 second = vec3(0.624,0.847,0.475);
   vec3 third = vec3(0.51,0.678,0.408);
   vec3 fourth = vec3(0.537,0.396,0.361);
   vec3 fifth = vec3(0.31,0.231,0.204);
   vec3 sixth = vec3(0.243,0.259,0.357);
   vec3 black  = vec3(0.098,0.133,0.208); // Black
