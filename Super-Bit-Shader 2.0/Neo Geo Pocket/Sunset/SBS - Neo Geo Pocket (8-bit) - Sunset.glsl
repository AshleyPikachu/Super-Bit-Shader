...
void main()
{
   ...
   vec3 first = vec3(0.922,0.867,0.761);
   vec3 second = vec3(0.957,0.655,0.565);
   vec3 third = vec3(0.706,0.584,0.424);
   vec3 fourth = vec3(0.475,0.435,0.604);
   vec3 fifth = vec3(0.486,0.243,0.38);
   vec3 sixth = vec3(0.235,0.176,0.129);
   vec3 black  = vec3(0.09,0.024,0.2);
