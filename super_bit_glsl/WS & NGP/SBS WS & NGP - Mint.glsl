...
{
   // palette
   vec3 white  = vec3(0.835,0.937,0.859); // White
   vec3 first = vec3(0.678,1.,0.965);
   vec3 second = vec3(0.478,0.839,0.651);
   vec3 third = vec3(0.408,0.667,0.408);
   vec3 fourth = vec3(0.353,0.451,0.529);
   vec3 fifth = vec3(0.196,0.29,0.298);
   vec3 sixth = vec3(0.322,0.239,0.349);
   vec3 black  = vec3(0.094,0.094,0.2); // Black
