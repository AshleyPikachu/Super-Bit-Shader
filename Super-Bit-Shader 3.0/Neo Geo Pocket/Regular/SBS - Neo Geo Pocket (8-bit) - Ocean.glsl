...
// Recommended Console: Neo Geo Pocket (Beetle NeoPop)
...
{
   // palette
   vec3 white  = vec3(0.984,0.945,0.816);
   vec3 first = vec3(0.757,0.894,0.984);
   vec3 second = vec3(0.412,0.808,0.608);
   vec3 third = vec3(0.212,0.667,0.718);
   vec3 fourth = vec3(0.263,0.475,0.647);
   vec3 fifth = vec3(0.325,0.318,0.451);
   vec3 sixth = vec3(0.137,0.196,0.29);
   vec3 black  = vec3(0.004,0.047,0.224);
