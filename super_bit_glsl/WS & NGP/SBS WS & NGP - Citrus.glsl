...
{
   // palette
   vec3 white  = vec3(0.949,0.918,0.843); // White
   vec3 first = vec3(1.,1.,0.71);
   vec3 second = vec3(0.757,0.839,0.478);
   vec3 third = vec3(0.612,0.678,0.4);
   vec3 fourth = vec3(0.361,0.522,0.537);
   vec3 fifth = vec3(0.204,0.31,0.31);
   vec3 sixth = vec3(0.188,0.22,0.298);
   vec3 black  = vec3(0.067,0.102,0.176); // Black
