...
{
   // palette
   vec3 white  = vec3(0.992,0.953,0.663);
   vec3 first = vec3(1.,0.835,0.725);
   vec3 second = vec3(0.878,0.71,0.118);
   vec3 third = vec3(1.,0.4,0.337);
   vec3 fourth = vec3(0.682,0.306,0.667);
   vec3 fifth = vec3(0.525,0.231,0.357);
   vec3 sixth = vec3(0.,0.188,0.427);
   vec3 black  = vec3(0.039,0.016,0.278);
