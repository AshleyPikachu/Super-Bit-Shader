...
// Core Palette
   ...
   vec3 first = vec3(0.898,0.957,0.827);
   vec3 second = vec3(0.937,0.859,0.773);
   vec3 third = vec3(0.925,0.784,0.616);
   vec3 fourth = vec3(0.584,0.784,0.541);
   vec3 fifth = vec3(0.416,0.729,0.576);
   vec3 sixth = vec3(0.541,0.635,0.443);
   vec3 seventh = vec3(0.451,0.584,0.416);
   vec3 eighth = vec3(0.267,0.51,0.561);
   vec3 ninth = vec3(0.18,0.439,0.51);
   vec3 tenth = vec3(0.416,0.294,0.267);
   vec3 eleventh = vec3(0.4,0.212,0.173);
   vec3 twelfth = vec3(0.176,0.196,0.125);
   vec3 thirteenth = vec3(0.098,0.137,0.075);
   vec3 fourteenth = vec3(0.169,0.,0.106);
   vec3 black  = vec3(0.114,0.,0.067);
