...
{
   // palette
   vec3 white  = vec3(0.914,0.949,0.843); // White
   vec3 first = vec3(1.,0.725,0.678);
   vec3 second = vec3(0.761,0.561,0.878);
   vec3 third = vec3(0.553,0.408,0.678);
   vec3 fourth = vec3(0.392,0.447,0.561);
   vec3 fifth = vec3(0.271,0.286,0.373);
   vec3 sixth = vec3(0.357,0.243,0.267);
   vec3 black  = vec3(0.2,0.094,0.118); // Black
