...
{
   // palette
   vec3 white  = vec3(0.843,0.859,0.949); // White
   vec3 first = vec3(0.792,0.725,1.);
   vec3 second = vec3(0.902,0.694,0.58);
   vec3 third = vec3(0.725,0.498,0.725);
   vec3 fourth = vec3(0.576,0.435,0.592);
   vec3 fifth = vec3(0.412,0.322,0.329);
   vec3 sixth = vec3(0.357,0.361,0.455);
   vec3 black  = vec3(0.231,0.235,0.325); // Black
