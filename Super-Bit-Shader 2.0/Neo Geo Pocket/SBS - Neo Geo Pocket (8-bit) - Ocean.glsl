...
void main()
{
   ...
   vec3 first = vec3(0.741,0.906,0.929);
   vec3 second = vec3(0.718,0.722,0.878);
   vec3 third = vec3(0.333,0.659,0.667);
   vec3 fourth = vec3(0.275,0.475,0.667);
   vec3 fifth = vec3(0.286,0.314,0.573);
   vec3 sixth = vec3(0.067,0.208,0.227);
   vec3 black  = vec3(0.004,0.047,0.22);
