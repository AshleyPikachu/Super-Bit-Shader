...
void main()
{
   ...
   vec3 first = vec3(0.871,0.875,0.871);
   vec3 second = vec3(0.741,0.729,0.741);
   vec3 third = vec3(0.612,0.604,0.612);
   vec3 fourth = vec3(0.451,0.459,0.451);
   vec3 fifth = vec3(0.322,0.333,0.322);
   vec3 sixth = vec3(0.192,0.188,0.192);
