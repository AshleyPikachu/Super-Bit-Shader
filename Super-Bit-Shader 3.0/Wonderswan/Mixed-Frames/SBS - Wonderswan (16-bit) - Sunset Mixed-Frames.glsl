...
{
// Core Palette
   vec3 white  = vec3(1.,0.976,0.686);
   vec3 first = vec3(0.969,0.929,0.639);
   vec3 second = vec3(1.,0.839,0.725);
   vec3 third = vec3(0.941,0.776,0.671);
   vec3 fourth = vec3(0.878,0.71,0.118);
   vec3 fifth = vec3(0.808,0.647,0.);
   vec3 sixth = vec3(1.,0.4,0.337);
   vec3 seventh = vec3(0.929,0.325,0.275);
   vec3 eighth = vec3(0.682,0.306,0.667);
   vec3 ninth = vec3(0.631,0.22,0.62);
   vec3 tenth = vec3(0.2,0.325,0.58);
   vec3 eleventh = vec3(0.118,0.267,0.518);
   vec3 twelfth = vec3(0.361,0.063,0.212);
   vec3 thirteenth = vec3(0.275,0.,0.145);
   vec3 fourteenth = vec3(0.039,0.016,0.278);
   vec3 black  = vec3(0.,0.,0.212);
